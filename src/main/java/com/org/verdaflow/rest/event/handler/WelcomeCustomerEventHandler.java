...
@Component
public class WelcomeCustomerEventHandler implements ApplicationListener<WelcomeCustomerEvent> {
	public static final Logger log = LoggerFactory.getLogger(WelcomeCustomerEventHandler.class);
	...
	@Override
	public void onApplicationEvent(WelcomeCustomerEvent event) {
		log.info("onApplicationEvent");
		String subject = StringConst.SUBJECT_ORG_WELCOME_CUSTOMER;
		...
		String msg = VelocityEngineUtils.mergeTemplateIntoString(velocityEngine, "templates/emails/WelcomeCustomer.vsl",
		...
		try {
			...
			log.error(new StringBuilder(StringConst.ERROR_SENDING_WELCOME_CUSTOMER_MAIL_TO).append(event.getEmail())
